...
- [ ] Fetch `https://blockeddrainssheffield.co.uk/sitemap.xml` - confirm HTTP 200
...
- [ ] Fetch `https://blockeddrainssheffield.co.uk/robots.txt` - confirm HTTP 200
...
- [ ] Fetch `https://blockeddrainssheffield.co.uk/llm.html` - confirm HTTP 200
...
- [ ] Submit sitemap at `https://blockeddrainssheffield.co.uk/sitemap.xml`
