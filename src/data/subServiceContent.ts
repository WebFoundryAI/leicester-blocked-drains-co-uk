...
export const SUB_SERVICE_CONTENT: Record<string, SubServiceContent> = {
  ...
  "blocked-bath": {
    ...
    relatedLinks: [
      ...
      { text: "Drain unblocking in Rotherham", href: "/locations/rotherham/drain-unblocking/" }
    ]
  },
